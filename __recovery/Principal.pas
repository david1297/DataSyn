...
begin
  ...
  Memo1.Lines.Add('  -Cantidad de Bodegas: ' + Numero.ToString);
end;
...
begin
  ...
  Begin
    ...
    try
      ...
      Begin
        ...
        vQ.ParamByName('').AsFloat := QDet_Prod.AsFloat;
        vQ.ParamByName('').AsFloat := QDet_Prod.AsFloat;

        vQ.ParamByName('NUMERO').AsInteger := QDet_ProdNUMERO.AsInteger;
        vQ.ParamByName('').AsInteger := QDet_Prod.AsInteger;
        vQ.ParamByName('').AsInteger := QDet_Prod.AsInteger;
        vQ.ParamByName('').AsInteger := QDet_Prod.AsInteger;
        ...
        vQ.ParamByName('').AsString := QDet_Prod.AsString;
        vQ.ParamByName('').AsString := QDet_Prod.AsString;

        , , , , ' + ' VRL_TOTAL,
          IVA, IVA_VALOR, DESCTO, TOTAL_PARC, DESCTOP, COSTOP, COSTOU, UTIL_P, ' + ' UTIL_U, DCTFIJO, DCTCLIENTE, DCTADICIONAL, LAMINA, ESTILO,
          UNIDADES_POR_JUEGO,
          ' + ' LARGO,ANCHO,MATERIAL,TINTAS,ALTO,CARAS,TIPO,ID_EMPRESA,ID_SUCURSAL,CONTEO,'
          + ' TOTALDCT,VLR_UNITARIO_MEXT,COLOR,DCTO_AD1,DCTO_AD2,VLR_DCTFIJO,VLR_DCT,'
          + ' VLR_DCTOAD1,VLR_DCTOAD2,VLR_DCTOADICIONAL,COD_UNIDAD_VENTA,FACTOR,'
  ...
  Memo1.Lines.Add('  -Cantidad de Cotizaciones: ' + Numero.ToString);
end;
